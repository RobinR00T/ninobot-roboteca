  ...
  stories: [
    ...
    },
    {
      ...
      nodes: {
        ...
        n2b: {
          text: { es: "¡Zas! Llegáis al Cretácico. Detrás de una roca asoma... ¡un T-Rex bebé! Quiere jugar al escondite, pero se esconde fatal: su cola siempre asoma.", ca: "Zas! Arribeu al Cretaci. Darrere d'una roca treu el cap... un T-Rex nadó! Vol jugar a fet i amagar, però s'amaga fatal: la seva cua sempre es veu.", en: "Zap! You arrive in the Cretaceous. From behind a rock peeks... a baby T-Rex! It wants to play hide-and-seek, but it is terrible at hiding: its tail always sticks out.", cs: "Šup! Přistanete v křídě. Zpoza kamene vykukuje... malý T-Rex! Chce si hrát na schovávanou, ale schovává se příšerně: ocas mu vždycky kouká ven.", fr: "Zou ! Vous arrivez au Crétacé. Derrière un rocher apparaît... un bébé T-Rex ! Il veut jouer à cache-cache, mais il se cache très mal : sa queue dépasse toujours." },
          choices: [
