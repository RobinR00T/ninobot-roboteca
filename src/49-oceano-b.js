...
Object.assign(THEMES.oceano.content, {
  ...
  explore: {
    ...
    cats: [
      { id: "orilla", emoji: "🏖️", x: 100, name: { es: "La orilla", ca: "La vora", en: "The shore", cs: "Pobřeží", fr: "Le rivage" } },
      { id: "arrecife", emoji: "🪸", x: 760, name: { es: "El arrecife", ca: "L'escull", en: "The reef", cs: "Útes", fr: "Le récif" } },
      { id: "marabierto", emoji: "🌊", x: 1700, name: { es: "Mar abierto", ca: "Mar obert", en: "Open sea", cs: "Širé moře", fr: "Pleine mer" } },
      { id: "profundo", emoji: "🕳️", x: 2660, name: { es: "Profundidades", ca: "Profunditats", en: "The deep", cs: "Hlubiny", fr: "Les profondeurs" } }
    ],
    pois: [
      { cat: "orilla", emoji: "🐢", x: 390, y: 300,
      ...
      { cat: "arrecife", emoji: "🪸", x: 860, y: 640, size: 2,
      ...
      { cat: "arrecife", emoji: "🐠", x: 1090, y: 430,
      ...
      { cat: "arrecife", emoji: "🐙", x: 1320, y: 700,
      ...
      { cat: "arrecife", emoji: "🐡", x: 1550, y: 440,
      ...
      { cat: "marabierto", emoji: "🐬", x: 1800, y: 250,
      ...
      { cat: "marabierto", emoji: "🐋", x: 2060, y: 520, size: 2,
      ...
      { cat: "marabierto", emoji: "🦈", x: 2320, y: 760,
      ...
      { cat: "marabierto", emoji: "🪼", x: 2540, y: 430,
      ...
      { cat: "profundo", emoji: "🔦", x: 3645, y: 860,
      ...
      { cat: "profundo", emoji: "🦑", x: 2985, y: 560,
      ...
      { cat: "profundo", emoji: "🌋", x: 3205, y: 910,
      ...
      { cat: "profundo", emoji: "🕳️", x: 4072, y: 900,
