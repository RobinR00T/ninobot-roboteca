...
Object.assign(THEMES.tierramedia.content, {
  ...
  explore: {
    ...
    cats: [
      ...
      { id: "montanas", emoji: "🏔️", x: 850, name: { es: "Montañas", ca: "Muntanyes", en: "Mountains", cs: "Hory", fr: "Montagnes" } },
      { id: "reinos", emoji: "🏰", x: 1500, name: { es: "Reinos", ca: "Regnes", en: "Kingdoms", cs: "Království", fr: "Royaumes" } },
      { id: "oscuras", emoji: "🌋", x: 2150, name: { es: "Tierras oscuras", ca: "Terres fosques", en: "Dark lands", cs: "Temné země", fr: "Terres sombres" } }
    ],
    pois: [
      { cat: "comarca", emoji: "🏡", x: 200, y: 520, size: 2,
      ...
      { cat: "montanas", emoji: "🏞️", x: 880, y: 420, size: 2,
      ...
      { cat: "montanas", emoji: "⛰️", x: 1100, y: 550,
      ...
      { cat: "montanas", emoji: "🦅", x: 1280, y: 380,
      ...
      { cat: "reinos", emoji: "🌟", x: 1520, y: 480, size: 2,
      ...
      { cat: "oscuras", emoji: "🗼", x: 2180, y: 520,
      ...
      { cat: "oscuras", emoji: "🌋", x: 2360, y: 620, size: 2,
      ...
      { cat: "oscuras", emoji: "🔥", x: 2500, y: 450,
