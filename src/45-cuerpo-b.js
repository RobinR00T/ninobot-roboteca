...
Object.assign(THEMES.cuerpo.content, {
  ...
  explore: {
    ...
    cats: [
      { id: "cabeza", emoji: "🧠", x: 250, name: { es: "Cabeza", ca: "Cap", en: "Head", cs: "Hlava", fr: "Tête" } },
      { id: "pecho", emoji: "❤️", x: 250, name: { es: "Pecho", ca: "Pit", en: "Chest", cs: "Hrudník", fr: "Poitrine" } },
      { id: "barriga", emoji: "🫃", x: 250, name: { es: "Barriga", ca: "Panxa", en: "Tummy", cs: "Bříško", fr: "Ventre" } },
      { id: "cuerpo", emoji: "💪", x: 1900, name: { es: "Todo el cuerpo", ca: "Tot el cos", en: "Whole body", cs: "Celé tělo", fr: "Tout le corps" } }
    ],
    pois: [
      { cat: "cabeza", emoji: "🧠", x: 560, y: 100, size: 2,
      ...
      { cat: "pecho", emoji: "❤️", x: 660, y: 455, size: 2,
      ...
      { cat: "cuerpo", emoji: "🖐️", x: 2350, y: 368,
