...
Object.assign(THEMES.animales.content, {
  ...
  explore: {
    ...
    cats: [
      { id: "selva", emoji: "🌴", x: 100, name: { es: "Selva", ca: "Selva", en: "Jungle", cs: "Džungle", fr: "Jungle" } },
      { id: "sabana", emoji: "🌾", x: 1300, name: { es: "Sabana", ca: "Sabana", en: "Savannah", cs: "Savana", fr: "Savane" } },
      { id: "polo", emoji: "🧊", x: 2480, name: { es: "Montañas y polos", ca: "Muntanyes i pols", en: "Mountains and poles", cs: "Hory a póly", fr: "Montagnes et pôles" } },
      { id: "desierto", emoji: "🏜️", x: 3520, name: { es: "Desierto", ca: "Desert", en: "Desert", cs: "Poušť", fr: "Désert" } }
    ],
    pois: [
      { cat: "selva", emoji: "🐒", x: 230, y: 430,
      ...
      { cat: "sabana", emoji: "🦁", x: 1420, y: 520, size: 2,
      ...
      { cat: "desierto", emoji: "🐫", x: 3630, y: 430, size: 2,
      ...
      { cat: "desierto", emoji: "🦊", x: 3860, y: 620,
      ...
      { cat: "desierto", emoji: "🦎", x: 4085, y: 460,
