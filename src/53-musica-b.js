...
Object.assign(THEMES.musica.content, {
  ...
  explore: {
    ...
    cats: [
      ...
      { id: "vientos", emoji: "🎺", x: 1200, name: { es: "Vientos", ca: "Vents", en: "Winds", cs: "Dechy", fr: "Vents" } },
      { id: "percusion", emoji: "🥁", x: 2010, name: { es: "Percusión", ca: "Percussió", en: "Percussion", cs: "Bicí", fr: "Percussions" } },
      { id: "escenario", emoji: "🎤", x: 3070, name: { es: "El escenario", ca: "L'escenari", en: "The stage", cs: "Jeviště", fr: "La scène" } }
    ],
    pois: [
      { cat: "cuerdas", emoji: "🎻", x: 240, y: 420,
      ...
      { cat: "cuerdas", emoji: "🎻", x: 490, y: 560, size: 2,
      ...
      { cat: "vientos", emoji: "🪈", x: 1285, y: 380,
      ...
      { cat: "vientos", emoji: "🎺", x: 1460, y: 560,
      ...
      { cat: "vientos", emoji: "🎷", x: 1620, y: 390,
      ...
      { cat: "vientos", emoji: "📯", x: 1770, y: 590,
      ...
      { cat: "percusion", emoji: "🥁", x: 2140, y: 570, size: 2,
        name: { es: "El gong", ca: "El gong", en: "The gong", cs: "Gong", fr: "Le gong" },
        fact: { es: "Un disco de bronce enorme colgado de su soporte. Se toca con una maza blandita y sigue vibrando un buen rato: en la orquesta anuncia los momentos más grandes.", ca: "Un disc de bronze enorme penjat del seu suport. Es toca amb una maça tova i segueix vibrant una bona estona: a l'orquestra anuncia els moments més grans.", en: "A huge bronze disc hanging from its stand. You play it with a soft mallet and it keeps vibrating for ages: in the orchestra it announces the biggest moments.", cs: "Obrovský bronzový kotouč zavěšený ve stojanu. Hraje se na něj měkkou paličkou a ještě dlouho se chvěje: v orchestru ohlašuje ty největší chvíle.", fr: "Un disque de bronze énorme accroché à son support. On le frappe avec une mailloche douce et il continue de vibrer un bon moment : dans l'orchestre, il annonce les plus grands moments." } },
      { cat: "percusion", emoji: "🥁", x: 2400, y: 430, size: 2,
      ...
      { cat: "percusion", emoji: "🎼", x: 2640, y: 610,
        name: { es: "El xilófono", ca: "El xilòfon", en: "The xylophone", cs: "Xylofon", fr: "Le xylophone" },
        fact: { es: "Láminas de colores que suenan como gotas de agua. Se toca con baquetas de bolita.", ca: "Làmines de fusta pintades de colors que sonen com gotes d'aigua. Es toca amb baquetes de boleta.", en: "Wooden bars painted in bright colours that sound like drops of water. Played with little ball mallets.", cs: "Dřevěné destičky natřené barvami, které zní jako kapky vody. Hraje se paličkami s kuličkou.", fr: "Des lames de bois peintes de couleurs vives qui sonnent comme des gouttes d'eau. On joue avec des baguettes à boule." } },
      { cat: "percusion", emoji: "🔔", x: 2830, y: 430,
      ...
      { cat: "escenario", emoji: "🪄", x: 3160, y: 545, size: 2,
      ...
      { cat: "escenario", emoji: "🎹", x: 3420, y: 600,
      ...
      { cat: "escenario", emoji: "🎤", x: 3615, y: 420,
      ...
      { cat: "escenario", emoji: "👏", x: 4090, y: 790,
