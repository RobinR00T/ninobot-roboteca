...
Object.assign(THEMES.musica.content, {
  ...
  explore: {
    ...
    cats: [
      ...
      { id: "vientos", emoji: "🎺", x: 1140, name: { es: "Vientos", ca: "Vents", en: "Winds", cs: "Dechy", fr: "Vents" } },
      { id: "percusion", emoji: "🥁", x: 2120, name: { es: "Percusión", ca: "Percussió", en: "Percussion", cs: "Bicí", fr: "Percussions" } },
      { id: "escenario", emoji: "🎤", x: 2830, name: { es: "El escenario", ca: "L'escenari", en: "The stage", cs: "Jeviště", fr: "La scène" } }
    ],
    pois: [
      ...
      { cat: "cuerdas", emoji: "🎻", x: 490, y: 600, size: 2,
      ...
      { cat: "vientos", emoji: "🪈", x: 1240, y: 380,
      ...
      { cat: "vientos", emoji: "🎺", x: 1490, y: 560,
      ...
      { cat: "vientos", emoji: "🎷", x: 1740, y: 390,
      ...
      { cat: "vientos", emoji: "📯", x: 1990, y: 600,
      ...
      { cat: "percusion", emoji: "🥁", x: 2230, y: 430, size: 2,
      ...
      { cat: "percusion", emoji: "🎼", x: 2470, y: 620,
      ...
      { cat: "percusion", emoji: "🔔", x: 2700, y: 400,
      ...
      { cat: "escenario", emoji: "🪄", x: 2940, y: 520, size: 2,
      ...
      { cat: "escenario", emoji: "🎹", x: 3400, y: 600,
      ...
      { cat: "escenario", emoji: "🎤", x: 3630, y: 380,
      ...
      { cat: "escenario", emoji: "👏", x: 4085, y: 760,
