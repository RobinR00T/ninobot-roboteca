...
(function () {
  ...
  /* lienzo más estrecho: el cuerpo entero cabe en pantalla */
  ex.width = 1500;
  ex.poikMax = 1.15; /* los órganos no se inflan: proporción fiel con el cuerpo */
  ex.cats.forEach((c, i) => { c.x = i < 3 ? 40 : 1100; });
  ex.cats.splice(3, 0, { id: "huesos", emoji: "🦴", x: 620, name: { es: "Los huesos", ca: "Els ossos", en: "The bones", cs: "Kosti", fr: "Les os" } });
  ...
  const ICONS = {
    ...
    "👂": { w: 40, h: 54, svg: bb(`
      <path d="M30 34 Q26 8 52 8 Q78 10 74 40 Q70 62 54 74 Q40 84 34 72 Q30 64 40 60 Q52 56 52 44 Q52 32 42 34 Q34 36 34 44" fill="#f3c39e" stroke="#c98d64" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>`, "0 0 100 92") },
    ...
    "❤️": { w: 82, h: 88, svg: bb(`
      ...
      <path d="M30 40 Q26 50 32 58" stroke="#e89a9a" stroke-width="2.4" fill="none" stroke-linecap="round"/>`, "0 0 100 96") },
    ...
    "🫁": { w: 132, h: 111, svg: bb(`
      ...
      <path d="M24 52 Q32 56 38 52 M62 52 Q68 56 76 52" stroke="#c9645e" stroke-width="2" fill="none"/>`, "0 0 100 94") },
    ...
    "🍲": { w: 72, h: 75, svg: bb(`
      ...
      <path d="M36 52 Q48 44 62 52 M34 64 Q48 56 66 64" stroke="#c86a54" stroke-width="2.4" fill="none" stroke-linecap="round"/>`, "0 0 100 96") },
    ...
    "➰": { w: 128, h: 106, svg: bb(`
      ...
      <path d="M16 44 Q16 58 30 58 Q44 58 44 48 Q44 40 56 40 Q68 40 68 52 Q68 64 54 64 Q40 64 40 74 Q40 84 56 84 Q74 84 80 70" stroke="#f2b096" stroke-width="7" fill="none" stroke-linecap="round"/>`, "0 0 100 96") },
    ...
    "🫘": { w: 60, h: 66, svg: bb(`
      ...
      <rect x="46" y="66" width="3.4" height="20" rx="1.7" fill="#e0c060"/><rect x="52" y="66" width="3.4" height="20" rx="1.7" fill="#e0c060"/>`, "0 0 100 92") },
    ...
    "💪": { w: 74, h: 64, svg: bb(`
      ...
      <path d="M34 62 Q46 52 58 60" stroke="#b56542" stroke-width="3" fill="none" stroke-linecap="round"/>`, "0 0 100 92") },

    "🦴": { w: 36, h: 88, svg: bb(`
      <path d="M32 20 Q32 6 42 6 Q52 6 52 16 Q62 16 62 26 Q62 36 50 34 L46 66 Q58 68 56 78 Q54 88 44 86 Q44 96 34 94 Q24 92 28 82 Q18 80 20 70 Q22 62 34 64 L38 34 Q26 36 26 26 Q26 20 32 20 Z" fill="#f5efe4" stroke="#c9bfa8" stroke-width="2.4"/>`, "0 0 84 100") },

    "🩸": { w: 62, h: 81, svg: bb(`
      <path d="M50 6 Q78 44 78 62 Q78 88 50 88 Q22 88 22 62 Q22 44 50 6 Z" fill="#d63a3a" stroke="#9e1f1f" stroke-width="2.6"/>
      <circle cx="40" cy="62" r="7" fill="#f08585"/><circle cx="58" cy="70" r="5.4" fill="#f08585"/><circle cx="56" cy="52" r="4.6" fill="#fff" opacity=".85"/>`, "0 0 100 96") },
    ...
    "🖐️": { w: 80, h: 68, svg: bb(`
      ...
      <path d="M30 20 Q30 8 38 8 Q44 8 44 18 M58 20 Q58 10 66 10 Q72 10 72 18" stroke="#5d4037" stroke-width="3.4" fill="none" stroke-linecap="round"/>`, "0 0 100 84") },
    ...
    "🧬": { w: 64, h: 94, svg: bb(`
      ...
      ${[14, 26, 54, 66, 80].map(y => `<line x1="34" y1="${y}" x2="66" y2="${y}" stroke="#4dd0e1" stroke-width="4" stroke-linecap="round"/>`).join("")}`, "0 0 100 100") }
  };
  ...
  if (gordo) {
    ...
    gordo.svg = bb(`
      ...
      <path d="M82 78 Q82 92 70 92" fill="none" stroke="#c98a6b" stroke-width="13" stroke-linecap="round"/>`, "0 0 104 100");
    gordo.iw = 128; gordo.ih = 106;
  }

  const femurPoi = ex.pois.find(p => p.emoji === "🦴" && p.cat !== "pecho");
  if (femurPoi) femurPoi.cat = "huesos";

  const HUESOS_NUEVOS = [
    { emoji: "💀", cat: "huesos", x: 810, y: 150, iw: 96, ih: 108,
      svg: bb(`
        ...
        <path d="M36 80 L36 90 M46 80 L46 92 M56 80 L56 92 M66 80 L66 90" stroke="#b5a888" stroke-width="3"/>`, "0 0 100 100"),
    ...
    { emoji: "🪜", cat: "huesos", x: 810, y: 545, iw: 46, ih: 130,
      svg: bb(`
        ...
        <circle cx="50" cy="96" r="6" fill="#f5efe4" stroke="#c9bfa8" stroke-width="2"/>`, "0 0 100 104"),
    ...
    { emoji: "🦴", cat: "huesos", x: 972, y: 405, iw: 34, ih: 120,
      svg: bb(`
        <path d="M50 8 Q38 2 34 10 Q30 18 40 22 L42 78 Q32 82 36 90 Q40 98 50 92 Q60 98 64 90 Q68 82 58 78 L60 22 Q70 18 66 10 Q62 2 50 8 Z" fill="#f5efe4" stroke="#c9bfa8" stroke-width="2.6"/>`, "0 0 100 100"),
    ...
    { emoji: "🦴", cat: "huesos", x: 972, y: 560, iw: 40, ih: 115,
      svg: bb(`
        ...
        <path d="M64 8 Q72 6 72 14 L68 86 Q68 94 61 93 Q54 92 56 84 L58 16 Q58 10 64 8 Z" fill="#f5efe4" stroke="#c9bfa8" stroke-width="2.6"/>`, "0 0 100 100"),
    ...
    { emoji: "🦴", cat: "huesos", x: 810, y: 674, iw: 86, ih: 58,
      svg: bb(`
        ...
        <circle cx="32" cy="38" r="9" fill="#d8ccb4"/><circle cx="68" cy="38" r="9" fill="#d8ccb4"/>`, "0 0 100 100"),
    ...
    { emoji: "🦴", cat: "huesos", x: 757, y: 745, iw: 40, ih: 160,
      svg: bb(`
        <circle cx="30" cy="14" r="11" fill="#f5efe4" stroke="#c9bfa8" stroke-width="2.6"/>
        <path d="M38 20 Q50 12 54 20 L50 78 Q60 82 56 90 Q50 97 44 91 Q36 95 34 87 Q33 81 41 78 L42 26 Q38 24 38 20 Z" fill="#f5efe4" stroke="#c9bfa8" stroke-width="2.6"/>`, "0 0 100 100"),
    ...
    { emoji: "🦴", cat: "huesos", x: 863, y: 900, iw: 44, ih: 150,
      svg: bb(`
        <path d="M34 6 Q24 4 24 14 L30 84 Q30 94 39 93 Q48 92 46 82 L42 16 Q42 8 34 6 Z" fill="#f5efe4" stroke="#c9bfa8" stroke-width="2.6"/>
        <path d="M66 10 Q74 8 74 16 L70 86 Q70 94 63 93 Q57 92 58 84 L60 18 Q60 12 66 10 Z" fill="#f5efe4" stroke="#c9bfa8" stroke-width="2.2"/>`, "0 0 100 100"),
  ...
  /* escenografía: DOS cuerpos paralelos: el de los ÓRGANOS (con carita)
     y el de los HUESOS (con el esqueleto completo), más el panel de sistemas */
  ex.deco = function () {
    const skin = "rgba(255,232,214,.30)";
    const bone = "rgba(255,255,255,.5)";
    let s = "";

    /* una silueta reutilizable: cx = centro; el original estaba centrado en 470 */
    const silueta = (cx) => {
      const d = cx - 470;
      return `<g fill="${skin}">
        <circle cx="${470 + d}" cy="175" r="118"/>
        <circle cx="${345 + d}" cy="195" r="20"/><circle cx="${595 + d}" cy="195" r="20"/>
        <rect x="${430 + d}" y="280" width="80" height="46" rx="18"/>
        <path d="M${340 + d} 330 Q${470 + d} 300 ${600 + d} 330 L${610 + d} 640 Q${470 + d} 690 ${330 + d} 640 Z"/>
        <rect x="${282 + d}" y="330" width="52" height="300" rx="26"/>
        <circle cx="${308 + d}" cy="655" r="30"/>
        <rect x="${606 + d}" y="330" width="52" height="300" rx="26"/>
        <circle cx="${632 + d}" cy="655" r="30"/>
        <rect x="${376 + d}" y="650" width="82" height="380" rx="40"/>
        <rect x="${482 + d}" y="650" width="82" height="380" rx="40"/>
        <path d="M${370 + d} 1030 Q${368 + d} 1058 ${400 + d} 1058 L${458 + d} 1052 L${458 + d} 1024 Z"/>
        <path d="M${570 + d} 1030 Q${572 + d} 1058 ${540 + d} 1058 L${482 + d} 1052 L${482 + d} 1024 Z"/>
      </g>`;
    };
    ...
    s += `<g stroke="${bone}" fill="none" stroke-linecap="round">
      <circle cx="810" cy="165" r="80" stroke-width="6"/>
      <line x1="810" y1="300" x2="810" y2="620" stroke-width="9"/>
      <path d="M760 610 Q810 650 860 610 M770 640 L810 615 L850 640" stroke-width="6"/>
      <line x1="648" y1="345" x2="648" y2="470" stroke-width="6"/><line x1="648" y1="480" x2="648" y2="615" stroke-width="6"/><circle cx="648" cy="475" r="6" stroke-width="4"/>
      <line x1="972" y1="345" x2="972" y2="470" stroke-width="6"/><line x1="972" y1="480" x2="972" y2="615" stroke-width="6"/><circle cx="972" cy="475" r="6" stroke-width="4"/>
      <line x1="757" y1="680" x2="757" y2="840" stroke-width="7"/><line x1="757" y1="852" x2="757" y2="1010" stroke-width="7"/><circle cx="757" cy="846" r="7" stroke-width="4"/>
      <line x1="863" y1="680" x2="863" y2="840" stroke-width="7"/><line x1="863" y1="852" x2="863" y2="1010" stroke-width="7"/><circle cx="863" cy="846" r="7" stroke-width="4"/>
      <line x1="770" y1="290" x2="850" y2="290" stroke-width="6"/>
    </g>`;
